...
docker exec host1 sh -c "apt-get update; apt-get -y install ssh telnet tcpdump traceroute mtr"
...
docker exec host2 sh -c "apt-get update; apt-get -y install ssh telnet tcpdump traceroute mtr"
